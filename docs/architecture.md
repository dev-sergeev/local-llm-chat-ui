...
- The **generation module** exposes scheduling, cancellation and bounded execution; it hides retries, the ten-minute deadline, background threads and response persistence.
